 ...
 * played. However, SoundFilters can be reused after they are finished by calling the reset method.
 * Assume all samples are 16, bit, signed, little-endian.
...
public abstract class SoundFilter {
	 ...
	 * This method returns o by default
	 */
	 ...
	 * offset and length are numbers of bytes, not samples
	 */
	 ...
	 */
	public static short getSamples(byte[] buffer, int position) {
		return (short)(
